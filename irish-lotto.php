...
<section class="single-product-page IrishLotto-product-bg">
...
<section class="product-tab-section">
	<div class="auto-container">
		<div class="product-tab">
			<ul class="product-tab-list nav-tabs IrishLotto-product-bg">
...
<section class="play-country-lotto-section bg-for-rishLotto">
	<div class="auto-container">
		<div class="play-country-lotto-row">
			...
			<div class="play-country-lotto-col">
				<div class="play-country-lotto-location">
					<img src="images/irishs-doc-img.png">
				</div>
