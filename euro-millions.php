...
<section class="single-product-page euro-product-bg">
...
<section class="product-tab-section">
	<div class="auto-container">
		<div class="product-tab">
			<ul class="product-tab-list nav-tabs">
...
<section class="play-country-lotto-section bg-for-euromillian">
	<div class="auto-container">
		<div class="play-country-lotto-row">
			<div class="play-country-lotto-col">
				<h2>Play Euromillions Lotto</h2>
			...
			<div class="play-country-lotto-col">
				<div class="play-country-lotto-location">
					<img src="images/euro-doc-img.png">
				</div>
