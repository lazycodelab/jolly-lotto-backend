...
<section class="single-product-page french-product-bg">
...
<section class="product-tab-section">
	<div class="auto-container">
		<div class="product-tab">
			<ul class="product-tab-list nav-tabs french-product-bg">
...
<section class="play-country-lotto-section bg-for-french">
	<div class="auto-container">
		<div class="play-country-lotto-row">
			...
			<div class="play-country-lotto-col">
				<div class="play-country-lotto-location">
					<img src="images/french-bg-img.png">
				</div>
