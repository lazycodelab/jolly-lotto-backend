...
<section class="single-product-page aus-product-bg">
...
<section class="product-tab-section">
	<div class="auto-container">
		<div class="product-tab">
			<ul class="product-tab-list nav-tabs aus-product-bg">
...
<section class="play-country-lotto-section">
	<div class="auto-container">
